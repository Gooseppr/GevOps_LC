...
> Lecture :
> - **backlog** : 7 issues (21.2 %)
> - **open** : 8 issues (24.2 %)
> - **in-progress** : 5 issues (15.2 %)
> - **closed** : 13 issues (39.4 %)
...
timeline
    ...
    in-progress : Terraform - monitoring : Terraform - Creation de l'inventaire Ansible : Ansible - Playbook pour le SSH Hardening : Ansible - Playbook pour deployer Postgres : Test du bastion
    closed : Test de Traefik : Reseau (IaC) - Definir et tester le VPC : Terraform - Deploiement des VM : Terraform - Deploiement du reseau et des subnets : Ansible - Playbook pour deployer Docker Swarm : Test API gateway : Test de la creation des sous reseaux : Test de la stack : Test de fck-nat : Creation du pipeline de compilation de l'image de NocoDB : Test de l'image localement de NocoDB : ... (+2 de plus)
```
