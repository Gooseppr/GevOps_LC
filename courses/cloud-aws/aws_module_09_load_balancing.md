...
> **SAA-C03** — Scale-in default : l'ASG termine d'abord dans l'**AZ la plus peuplée**, puis l'instance avec le **plus ancien launch template**. Changer d'AMI = créer un **nouveau launch template** (immuable).
